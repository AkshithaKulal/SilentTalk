# Run this ONCE on the F: machine in PowerShell:
#   Set-ExecutionPolicy -Scope Process Bypass -Force
#   cd F:\SilentTalk\isl_recognition
#   Then paste everything below from $code = @' through the final python smoke-test line.
#
# Or simply paste the whole block starting at $code = @'
...
New-Item -ItemType Directory -Force -Path "F:\SilentTalk\isl_recognition" | Out-Null
Set-Content -Path "F:\SilentTalk\isl_recognition\extract_landmarks.py" -Value $code -Encoding utf8
Write-Host "Wrote F:\SilentTalk\isl_recognition\extract_landmarks.py"
Get-Item "F:\SilentTalk\isl_recognition\extract_landmarks.py" | Format-List FullName, Length
